...
def main():
    ...
    parser.add_argument("--current-game-number", type=int, default=201, help="this is the serial number of current game, must a integer")
    ...
    parser.add_argument("--environment-config", type=str, default="./examples/werewolf-8-6.json", help="json file that define the rule and players")
